...
1) Unlimited Levels with Flexible Membership Pricing
2) Extensive Options for Content Restriction
3) Customizable Reports and Member Dashboards
4) 100% GPL and Integrated with Third Party Services
...
1. Go to Plugins > Add New to install **Cointopay Gateway for Paid Memberships Pro**, or
2. Download the latest version of the plugin.
3. Unzip the downloaded file to your computer.
4. Upload the /pmpro-cointopay-gateway/ directory to the /wp-content/plugins/ directory of your site.
